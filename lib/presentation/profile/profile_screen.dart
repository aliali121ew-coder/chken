              ...
              child: Column(
                children: [
                  ListTile(
                    ...
                    title: Text(l10n.profile_addresses),
                    trailing: const Icon(Icons.chevron_right),
                    onTap: () => context.push(AppRoutes.addresses),
                  ),
                  ListTile(
                    leading: const Icon(Icons.favorite_border),
                    title: Text(l10n.profile_wishlist),
                    trailing: const Icon(Icons.chevron_right),
                    onTap: () => context.push(AppRoutes.wishlist),
                  ),
                  ListTile(
                    leading: const Icon(Icons.notifications_outlined),
                    title: Text(l10n.profile_notifications),
                    trailing: const Icon(Icons.chevron_right),
                    onTap: () => context.push(AppRoutes.notifications),
                  ),
                  ListTile(
                    leading: const Icon(Icons.chat_bubble_outline),
                    title: Text(l10n.chat_conversations),
                    trailing: const Icon(Icons.chevron_right),
              ...
              child: Column(
                children: [
                  ListTile(
                    ...
                    title: Text(l10n.profile_referral),
                    trailing: const Icon(Icons.chevron_right),
                    onTap: () => context.push(AppRoutes.referral),
                  ),
                  ListTile(
                    leading: const Icon(Icons.help_outline),
                    title: Text(l10n.profile_support),
                    trailing: const Icon(Icons.chevron_right),
                    onTap: () {},
                  ),
                  ListTile(
                    leading: const Icon(Icons.info_outline),
                    title: Text(l10n.profile_about),
                    trailing: const Icon(Icons.chevron_right),
                    onTap: () {},
                  ),
                ],
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 4),
                    Text(l10n.profile_myWallet, style: theme.textTheme.bodySmall),
                  ],
                ),
              ),
            ),
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 4),
                    Text(l10n.profile_loyaltyPoints, style: theme.textTheme.bodySmall),
                  ],
                ),
              ),
            ),
